...
from helpers import map_positions, normalize, sleep, clear
...
class Game:
    ...
    def __set_random_secret_word(self):
        ...
        self.__hidden_word = [Game.__PLACEHOLDER_LETTER for _ in self.__secret_word]
    ...
    def __next_round(self):
        ...
        self.__won = Game.__PLACEHOLDER_LETTER not in self.__hidden_word
