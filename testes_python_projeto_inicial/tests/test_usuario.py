...
def test_deve_permitir_propor_lance_quando_valor_for_igual_ao_valor_da_carteira(vini, leilao):
    vini.propor_lance(leilao, 100.0)

    assert vini.carteira == 0.0


def test_nao_deve_permitir_propor_lance_quando_valor_for_maior_que_o_valor_da_carteira(vini, leilao):
